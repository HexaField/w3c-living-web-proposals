...
export const DocumentShape: ShapeDefinition = {
  ...
  constructor: [
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.ENTRY_TYPE, object: PREDICATES.DOCUMENT },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.DOC_TITLE, object: 'title' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.DOC_OWNER, object: 'owner' },
  ],
};
...
export const BlockShape: ShapeDefinition = {
  ...
  constructor: [
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.ENTRY_TYPE, object: PREDICATES.BLOCK },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.BLOCK_TYPE, object: 'type' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.BLOCK_CONTENT, object: 'content' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.BLOCK_AUTHOR, object: 'author' },
  ],
};
...
export const CommentShape: ShapeDefinition = {
  ...
  constructor: [
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.ENTRY_TYPE, object: PREDICATES.COMMENT },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.COMMENT_BODY, object: 'body' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.COMMENT_AUTHOR, object: 'author' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.COMMENT_TIME, object: 'time' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.COMMENT_BLOCK, object: 'blockId' },
  ],
};
...
export const CommentReplyShape: ShapeDefinition = {
  ...
  constructor: [
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.ENTRY_TYPE, object: PREDICATES.COMMENT_REPLY },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.REPLY_BODY, object: 'body' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.REPLY_AUTHOR, object: 'author' },
    { action: 'shape://actions/setSingleTarget', subject: 'this', predicate: PREDICATES.REPLY_TIME, object: 'time' },
  ],
};
